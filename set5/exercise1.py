...
def wordy_pyramid():
    ...
    first_list = list_of_words_with_lengths(list_of_lengths=list(range(3, 21, 2)))
    second_list = list_of_words_with_lengths(list_of_lengths=list(range(20, 3, -2)))

    pyramid_list = first_list + second_list
...
def list_of_words_with_lengths(list_of_lengths):
    ...
    for i in list_of_lengths:
        message = get_a_word_of_length_n(length = i)
